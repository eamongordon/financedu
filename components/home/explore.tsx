...
export function Explore() {
    return (
        <div className="flex flex-col md:flex-row gap-8 mx-4 sm:mx-6 lg:mx-12 my-6 sm:my-16">
            <div className="md:w-1/3 space-y-4 md:space-y-8">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">Our Mission</h2>
                <p className="mb-4">We are Financedu, a 501(c)(3) non-profit dedicated to providing financial education for youth of all ages. Our comprehensive, engaging curriculum and programs teach individuals the skills necessary for lifelong financial success!</p>
                <Button size="lg" className="w-36 bg-primary text-white py-2 px-4">About Us</Button>
            </div>
