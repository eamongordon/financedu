    ...
    return (
        ...
        >
            <div className="relative">
                ...
                <Image src={course.image ?? "/homepage-banner.jpg"} alt={course.title} width={64} height={64} className="rounded-lg before:absolute before:inset-0 before:bg-black before:opacity-50 before:rounded-lg before:w-10 before:h-10 opacity-10" />
            </div>
