...
function NavigationButtons({ lesson, previousLesson, nextLesson }: NavigationButtonsProps) {
...
function ActivityNavigation({ lesson, isLoggedIn }: ActivityNavigationProps) {
    const params = useParams<{ courseId: string; moduleId: string, lessonId: string }>();
...
export function LessonSidebar({ lesson, isLoggedIn, previousLesson, nextLesson }: LessonSidebarProps) {
    const params = useParams<{ courseId: string; moduleId: string, lessonId: string }>();
    const moduleId = params!.moduleId;
    const courseId = params!.courseId;
                ...
                <Drawer>
                    ...
                    <DrawerContent className="max-h-[calc(100vh-64px)] flex flex-col">
                        <div className="flex flex-col gap-4 items-start text-left flex-grow overflow-auto">
                            ...
                            <NavigationButtons lesson={lesson} isLoggedIn={isLoggedIn} previousLesson={previousLesson} nextLesson={nextLesson} />
                            <ActivityNavigation lesson={lesson} isLoggedIn={isLoggedIn} />
                        </div>
                    </DrawerContent>
                </Drawer>
            </div>
