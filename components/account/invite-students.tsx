...
function InviteBody({ classCode, className }: { classCode: string; className?: string }) {
    ...
    const inviteLink = `${baseUrl}/join?code=${classCode}`;
    const inviteLinkDisplay = `${baseUrlDisplay}/join?code=${classCode}`;
    ...
    return (
        <div className={className}>
            ...
            <p className="text-muted-foreground">
                Have your students visit <Link href={`/join?code=${classCode}`} target="_blank" className="text-secondary font-semibold">{inviteLinkDisplay}</Link> and enter your class code: <span className="font-semibold text-foreground">{classCode}</span>.
            </p>
        </div>
    );
}